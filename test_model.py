...
from keras.applications import MobileNet, VGG19, VGG16, Xception
...
top_model.add(Dropout(.25)) # dropout Layer
...
history = model.fit_generator(datagen.flow(x_train,y_train, batch_size=batch_size),
                              epochs = epochs, 
                              validation_data = datagen2.flow(x_validate,y_validate, batch_size=batch_size),

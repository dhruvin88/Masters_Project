...
top_model.add(Dense(2,activation='softmax')) #final layer with softmax activation
...
sgd = keras.optimizers.SGD(lr=.00001)
...
save_training_graph(history, 'With Pretrained Training Accuracy')
